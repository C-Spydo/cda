   ...
   <p>
    <span class="goback" ><a href="home.php">Go back to Home&nbsp;<span></span></a></span>
    	...
    	<div class="emp">
        	<div class="nav ">
            	<ul>
               <li><a href="#" <?php if (($page == 'comprofile.php')) { ?>class="active"<?php } ?>>View Communities</a></li>
              <li><a href="updatecom.php" <?php if (($page == 'updatecom.php')) { ?>class="active"<?php } ?>>Search & Update</a></li>  
                </ul>
            </div>
        	<div class="all_emp mCustomScrollbar" data-mcs-theme="minimal-dark">
			<div class="emp_label">Community Profile</div>
